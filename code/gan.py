...
pretrain_netD = 'last_checkpoint_vanilla_pretrain_encdec_Disc.pth.tar'
pretrain_netG = 'last_checkpoint_vanilla_pretrain_encdec_Gen.pth.tar'
train_GAN = 'last_checkpoint_vanilla_encdec_25Jan.pth.tar'
...
def pretrain(run_name, netD, netG, motion_length, claim_length, embedding_dim, hidden_dim_G, hidden_dim_D, lam, batch_size, epochs, num_words, train_data_dir, test_data_dir):
    ...
    for iteration in xrange(start_epoch,epochs+1):
        ...
        for training_step in range(training_steps):
            ...
            G_loss_1 = nllloss(fake, real_claim_D_v, claim_length)/batch_size
