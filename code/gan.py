...
def save_checkpoint(state, filename='last_checkpoint_vanilla_encdec_25Jan.pth.tar'):
...
def train(run_name, netG, netD, motion_length, claim_length, embedding_dim, hidden_dim_G, hidden_dim_D, lam, batch_size, epochs, iteration_d, num_words, train_data_dir, test_data_dir):
    ...
    start_epoch = 0
    if os.path.isfile('last_checkpoint_vanilla_encdec_25Jan.pth.tar'):
            print("=> loading checkpoint '{}'".format('last_checkpoint_vanilla_encdec_25Jan.pth.tar'))
            checkpoint = torch.load('last_checkpoint_vanilla_encdec_25Jan.pth.tar')
            ...
            print("=> loaded checkpoint '{}' (epoch {})"
                  .format('last_checkpoint_vanilla_encdec_25Jan.pth.tar', checkpoint['epoch']))
